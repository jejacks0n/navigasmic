...
describe "Navigasmic::Builder::ListBuilder", type: :helper do
  ...
  describe "rendering" do
    it "outputs basic example" do
      ...
      html = <<-HTML
        <ul id="primary" class="semantic-navigation">
    ...
    it "handles builder configurations" do
      ...
      html = <<-HTML
        <ul id="primary" class="nav nav-pills">
          <li class="group dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Group<b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="/path"><span>Label</span></a></li>
            </ul>
          </li>
          <li class="item dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Level 1<b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><span>Level 2</span></li>
            </ul>
          </li>
          <li><span>Foo</span></li>
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Dynamic Group<b class="caret"></b></a>
            <ul class="dropdown-menu">
