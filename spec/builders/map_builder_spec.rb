...
describe "Navigasmic::Builder::MapBuilder", type: :helper do
  ...
  describe "rendering" do
    it "outputs basic example" do
      ...
      xml = <<-XML
        <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd" changefreq="yearly">
          <url>
    ...
    it "handles builder configurations" do
      ...
      xml = <<-XML
        <urlset changefreq="weekly" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd">
          <url>
            <loc>http://test.host/path</loc>
            <name>Label</name>
          </url>
